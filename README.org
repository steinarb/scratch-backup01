    ...
    1. A src/main/feature/feature.xml template file, referencing the authservice feature repository and the authservice feature, e.g.:
       #+BEGIN_SRC nxml
         ...
         <features xmlns="http://karaf.apache.org/xmlns/features/v1.4.0" name="authservice.bundle">
             <repository>mvn:no.priv.bang.authservice/authservice/1.1.0/xml/features</repository>
...
Possible approach:
 1. Copy the [[https://github.com/steinarb/authservice/tree/master/authservice.db.postgresql][authservice postgresql maven project]]
 2. Remove the [[https://github.com/steinarb/authservice/blob/master/authservice.db.postgresql/pom.xml#L107][postgresql compile scope dependency from the pom.xml]] (this dependency adds a bundle dependency to the feature file)
