...
public class UserAdminWebApiServlet extends ServletContainer {
    ...
    protected void init(WebConfig webConfig) throws ServletException {
        ...
        logservice.log(LogService.LOG_INFO, String.format("Authservice user admin API Jersey servlet initialized with WebConfig, with resources: %s  and config params: %s", classes.toString(), configProperties.toString()));
    }
