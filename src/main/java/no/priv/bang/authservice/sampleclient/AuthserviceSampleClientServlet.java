...
@Component(
    property= {
        ...
        HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_NAME+"=sampleauthserviceclient",
        HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_INIT_PARAM_PREFIX+ServerProperties.PROVIDER_PACKAGES+"=no.priv.bang.authservice.sampleclient.resources"},
    service=Servlet.class,
    immediate=true
)
public class AuthserviceSampleClientServlet extends ServletContainer {
