...
public class AuthserviceSampleClientServletTest extends ShiroTestBase {
    ...
    public void testGetRootIndexHtml() throws Exception {
        ...
        AuthserviceSampleClientServlet servlet = simulateDSComponentActivationAndWebWhiteboardConfiguration(logservice);
    ...
    private ServletConfig createServletConfigWithApplicationAndPackagenameForJerseyResources() {
        ...
        when(config.getInitParameter(eq(ServerProperties.PROVIDER_PACKAGES))).thenReturn("no.priv.bang.authservice.sampleclient.resources");
