 ...
 * be put in front of the servlets in the "/shirosessiontest1" webcontext, and
...
@Component(
    property= {
        ...
        "servletNames=shirotest1"},
    service=Filter.class,
    immediate=true
)
public class ShiroSessionTest1ShiroFilter extends AbstractShiroFilter { // NOSONAR
    ...
    static {
        ...
        INI_FILE.load(ShiroSessionTest1ShiroFilter.class.getClassLoader().getResourceAsStream("shiro.ini"));
    }
